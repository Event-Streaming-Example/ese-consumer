...
from components.configs import MailerViewConfig, DataSourceConfig

def get_mailer_config(ctx, config: DataSourceConfig) -> MailerViewConfig:
    ...
    return MailerViewConfig(queue_url, channel_name, config)